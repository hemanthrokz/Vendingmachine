...
//        System.out.println("////////////////////////////////////////////////////////////////////"+p1);
        ...
        while (true) {
            ...
            if (INVSELECT_VAL == 1  ) {
                if (product.get(1).getProductinventrycount()>0) {
                    incashAmount();
                    try {
           ...
           //  for inventry value 2
                ...
                if (product.get(2).getProductinventrycount()>0) {
                    incashAmount();
                    try {
                    ...
                    System.out.println("Sorry item unavialiable ,adding item to inventry try again sometime");
                    ms.addInventryCountUpdate(product, p2, INVSELECT_VAL);
                }
            }
            // for inventry value 3
            else if (INVSELECT_VAL == 3 ) {
                if (product.get(3).getProductinventrycount()>0) {
                    incashAmount();
                    try {
                    ...
                    System.out.println("Sorry item unavialiable ,adding item to inventry try again sometime");
                    ms.addInventryCountUpdate(product, p3, INVSELECT_VAL);
                }
            }
        }
